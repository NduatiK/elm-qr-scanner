...
var $author$project$Main$CameraClosed = {$: 'CameraClosed'};
var $author$project$Main$Model = F4(
	function (code, problems, cameraState, openLinks) {
		return {cameraState: cameraState, code: code, openLinks: openLinks, problems: problems};
	});
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Main$init = function (flags) {
	return _Utils_Tuple2(
		A4($author$project$Main$Model, '', _List_Nil, $author$project$Main$CameraClosed, true),
		$elm$core$Platform$Cmd$none);
};
var $author$project$Main$CameraOpened = function (a) {
	return {$: 'CameraOpened', a: a};
};
var $author$project$Main$GotCameraNotFoundError = {$: 'GotCameraNotFoundError'};
var $author$project$Main$ReceivedQRCode = function (a) {
	return {$: 'ReceivedQRCode', a: a};
};
...
var $author$project$Main$subscriptions = function (model) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				$author$project$Ports$receiveCameraActive($author$project$Main$CameraOpened),
				$author$project$Ports$scannedDeviceCode($author$project$Main$ReceivedQRCode),
				$author$project$Ports$noCameraFoundError(
				function (_v0) {
					return $author$project$Main$GotCameraNotFoundError;
				})
			]));
};
var $author$project$Main$CameraOpen = {$: 'CameraOpen'};
var $author$project$Main$CameraOpenError = {$: 'CameraOpenError'};
var $author$project$Main$CameraOpening = {$: 'CameraOpening'};
var $author$project$Main$NotALink = {$: 'NotALink'};
...
var $author$project$Ports$rerouteTo = _Platform_outgoingPort('rerouteTo', $elm$json$Json$Encode$string);
		...
		switch (msg.$) {
			case 'ToggleOpenLinks':
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$none);
			case 'ToggleCamera':
				return _Utils_eq(model.cameraState, $author$project$Main$CameraClosed) ? _Utils_Tuple2(
					_Utils_update(
						model,
						{
							cameraState: $author$project$Main$CameraOpening,
							problems: A2(
								$elm$core$List$filter,
								function (x) {
									return !_Utils_eq(x, $author$project$Main$CameraOpenError);
								},
								model.problems)
						}),
			...
			case 'CameraOpened':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							cameraState: isActive ? $author$project$Main$CameraOpen : $author$project$Main$CameraClosed
						}),
					$elm$core$Platform$Cmd$none);
			case 'GotCameraNotFoundError':
				var newError = $author$project$Main$CameraOpenError;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							problems: A2($elm$core$List$member, newError, model.problems) ? model.problems : A2($elm$core$List$cons, newError, model.problems)
						}),
					$elm$core$Platform$Cmd$none);
			default:
				var code = msg.a;
				var url = $elm$url$Url$fromString(code);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							code: code,
							problems: _Utils_eq(url, $elm$core$Maybe$Nothing) ? (A2($elm$core$List$member, $author$project$Main$NotALink, model.problems) ? model.problems : A2($elm$core$List$cons, $author$project$Main$NotALink, model.problems)) : A2(
								$elm$core$List$filter,
								function (x) {
									return !_Utils_eq(x, $author$project$Main$NotALink);
								},
								model.problems)
						}),
					$elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								...
								if (url.$ === 'Just') {
									var aUrl = url.a;
									return model.openLinks ? $author$project$Ports$rerouteTo(
										$elm$url$Url$toString(aUrl)) : $elm$core$Platform$Cmd$none;
								} else {
...
var $author$project$Main$ToggleCamera = {$: 'ToggleCamera'};
var $author$project$Main$ToggleOpenLinks = {$: 'ToggleOpenLinks'};
...
var $author$project$Main$CameraClosing = {$: 'CameraClosing'};
var $mdgriffith$elm_ui$Internal$Model$Bottom = {$: 'Bottom'};
var $mdgriffith$elm_ui$Element$alignBottom = $mdgriffith$elm_ui$Internal$Model$AlignY($mdgriffith$elm_ui$Internal$Model$Bottom);
var $author$project$Main$animatesAll = $mdgriffith$elm_ui$Element$htmlAttribute(
	A2($elm$html$Html$Attributes$style, 'transition', 'all 250ms 0ms'));
...
var $author$project$Main$viewScanner = function (cameraState) {
	var cameraStyle = (!_Utils_eq(cameraState, $author$project$Main$CameraClosed)) ? _List_fromArray(
		[
			$mdgriffith$elm_ui$Element$Border$color(
				...
				_Utils_ap(
					_List_fromArray(
						[
							...
							_Utils_eq(cameraState, $author$project$Main$CameraClosing) ? A2(
								$mdgriffith$elm_ui$Element$el,
								_List_fromArray(
									[
										$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
							...
							_Utils_ap(
								_List_fromArray(
									[
										...
										$mdgriffith$elm_ui$Element$alignLeft,
										$mdgriffith$elm_ui$Element$Background$color(
										A3($mdgriffith$elm_ui$Element$rgb255, 102, 218, 213))
									]),
								_Utils_eq(cameraState, $author$project$Main$CameraOpen) ? _List_fromArray(
									[
										$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
										$author$project$Main$animatesAll
									]) : _List_fromArray(
									[
										$mdgriffith$elm_ui$Element$width(
		...
		body: $elm$core$List$singleton(
			A2(
				...
				A2(
					...
					_List_fromArray(
						[
							(!_Utils_eq(model.cameraState, $author$project$Main$CameraClosed)) ? $author$project$Main$viewScanner(model.cameraState) : $mdgriffith$elm_ui$Element$none,
							A2(
							$mdgriffith$elm_ui$Element$column,
							_List_fromArray(
								[
								...
								[
										...
										]),
									{
										label: A2(
											$mdgriffith$elm_ui$Element$el,
											_List_Nil,
											(!_Utils_eq(model.cameraState, $author$project$Main$CameraClosed)) ? $author$project$Icons$cameraOff(_List_Nil) : $author$project$Icons$camera(_List_Nil)),
										onPress: $elm$core$Maybe$Just($author$project$Main$ToggleCamera)
									}),
									A2(
										...
										]),
									{
										label: A2(
											...
											_List_fromArray(
												[$mdgriffith$elm_ui$Element$centerX]),
											$mdgriffith$elm_ui$Element$text('Open links immediately')),
										onChange: $elm$core$Basics$always($author$project$Main$ToggleOpenLinks),
										...
										selected: $elm$core$Maybe$Just(model.openLinks)
									}),
									A2(
									...
									_List_fromArray(
										[
											$mdgriffith$elm_ui$Element$text(model.code)
										]))
								]))
						])))),
		title: 'Scanner'
